...
function Hand(props: IconProps) {
  return (
    ...
    >
      ...
      <Path
        d="M128,52V36a20,20,0,0,1,40,0V68a20,20,0,0,1,40,0v84a80,80,0,0,1-80,80c-44.18278,0-64-24-96.56854-92.71349a20,20,0,1,1,34.641-20L88,157.26608V52a20,20,0,0,1,40,0Z"
        opacity={0.2}
      />
      <Path
